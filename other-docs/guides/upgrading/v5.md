...
This feature does not require reindexing, however due to changes in the stemmer, relevance of autosuggest results can be improved by reindexing. [Reindexing can be performed at your discretion](docs://search/reindexing-content.md).
