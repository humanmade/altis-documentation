...
Reindexing is not required for existing post content, however the new Indexables will require an initial index. This can be [performed at your discretion](docs://search/reindexing-content.md).
...
This feature does not require reindexing, however due to changes in the stemmer, relevance of autosuggest results can be improved by reindexing. This can be [performed at your discretion](docs://search/reindexing-content.md).
