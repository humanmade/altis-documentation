...
Reindexing is not required for changes to fuzzy matching but _is_ required when user dictionaries are changed, unless using Elasticsearch version 7.8 or higher.
