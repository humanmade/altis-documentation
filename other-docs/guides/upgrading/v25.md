...
Altis v25 introduces support for PHP 8.4. It will first be available for testing in local server, then made available for upgrade on dev, 
staging and production environments.

#### Breaking changes:

- Deprecation of `php-v8js`: with the release of Altis v25, `php-v8js` is removed for PHP 8.4 and deprecated for earlier PHP versions
...
or block lists to cut out those annoying offenders. Automatic Web Application Firewall still protects your sites out of the box,
