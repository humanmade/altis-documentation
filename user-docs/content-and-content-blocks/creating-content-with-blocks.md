...
![image|300](../assets/creating-with-blocks-image36.png | width=300)
...
![](../assets/creating-with-blocks-image44.png)
Advanced
...
![](../assets/creating-with-blocks-image45.png)
...
- Click to switch between **editing** mode (the tick or check mark is next to the **pen** icon) or **selection** mode (tick is next to **Select**)
	![](../assets/creating-with-blocks-image14.png)
...
![](../assets/creating-with-blocks-image4.png)
- Click the **List view** icon to view the block types you have on the page,
    ![](../assets/creating-with-blocks-image41.png)

## How to add a block
- **At the top of the page**
    Click the **blue +**:
    ![](../assets/creating-with-blocks-image20.png)
- **Within blocks**
    Hover over a block and click the **+ sign**:
	![](../assets/creating-with-blocks-image33.png)
...
![](../assets/creating-with-blocks-image29.png)

Hover over a block name for an explanation and a preview:
![](../assets/creating-with-blocks-image5.png)

Click your chosen block, and it appears on your page:
![](../assets/creating-with-blocks-image8.png)
...
![](../assets/creating-with-blocks-image38.png)
...
![](../assets/creating-with-blocks-image23.png)
- Highlight
	Highlight the selected text with a different text or background color
	![](../assets/creating-with-blocks-image46.png)
- **Inline code**
...
![](../assets/creating-with-blocks-image1.png)
- **Inline image**
    Place an image within the text.
- **Keyboard input**
    Make selected text look like a keyboard command:
![](../assets/creating-with-blocks-image18.png)
- **Strikethrough**
...
1.  Highlight the **text** you want to **edit**. For this example, we’ll turn "$example" into **inline code**:
	![](../assets/creating-with-blocks-image32.png)
2.  Click the **Options** dropdown and click **Inline code**:
	![](../assets/creating-with-blocks-image17.png)
1.  That’s it!
	![](../assets/creating-with-blocks-image43.png)
4.  To remove the inline code, just open the dropdown again. The black box shows that Inline code is selected:
	![](../assets/creating-with-blocks-image30.png)
1.  Simply click again to **remove**

### More options for editing blocks

Click the Options icon:
![](../assets/creating-with-blocks-image34.png)
![](../assets/creating-with-blocks-image12.png)
...
![](../assets/creating-with-blocks-image21.png)
...
![](../assets/creating-with-blocks-image15.png)
...
![](../assets/creating-with-blocks-image11.png)
To **exit** the html editor, click  **block > Options > Edit visually**:
![](../assets/creating-with-blocks-image22.png)
...
- Paragraph
- Quote
![](../assets/creating-with-blocks-image19.png)
...
![](../assets/creating-with-blocks-image26.png)
...
![](../assets/creating-with-blocks-image47.png)
For example, multiple paragraphs transformed into a bulleted list:
![](../assets/creating-with-blocks-image48.png)
